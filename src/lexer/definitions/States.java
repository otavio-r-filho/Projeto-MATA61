...
import lexer.definitions.State;
...
public class States {
	...
	public static final State FOR			= new State(12, "FOR", true);
	...
	public static final State FLOAT			= new State(16, "FLOAT", true);
	...
	public static final State RETURN		= new State(29, "RETURN", true);
	public static final State ID18 			= new State(30, "ID18", true);
	public static final State ID19			= new State(31, "ID19", true);
	public static final State STR			= new State(32, "STR", true);
	...
	public static final State VOID			= new State(40, "VOID", true);
	...
	public static final State WHILE			= new State(45, "WHILE", true);
	public static final State PLUS			= new State(46, "PLUS", true);
	public static final State MINUS			= new State(47, "MINUS", true);
	public static final State ASTERISK		= new State(48, "ASTERISK", true);
	public static final State SLASH			= new State(49, "SLASH", true);
